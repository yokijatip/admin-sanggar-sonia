    ...
    <div class="max-w-7xl mx-auto space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div class="text-2xl font-bold">Rp {{ formatCurrency(stats.totalRevenue) }}</div>
            <p class="text-xs text-muted-foreground">
        ...
        <Card class="lg:col-span-2">
          <CardHeader>
            <div class="flex justify-between items-center">
              <div>
                ...
                <p class="text-sm text-muted-foreground">Monthly sales performance</p>
              </div>
              <Select>
          ...
          <CardContent>
            <div class="h-64 flex items-end justify-between gap-2">
              <div v-for="(value, index) in chartData" :key="index" class="flex flex-col items-center flex-1">
                <div 
                ...
                ></div>
                <span class="text-xs text-muted-foreground mt-2">{{ months[index] }}</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div class="space-y-4">
              <div v-for="product in topProducts" :key="product.id" class="flex items-center gap-4">
                ...
                <div class="text-right">
                  <p class="text-sm font-bold">Rp {{ formatCurrency(product.revenue) }}</p>
                  ...
                  <TableRow v-for="alert in filteredAlerts" :key="alert.id">
                    <TableCell>
                      <div class="flex items-center gap-3">
                        <img :src="alert.image" :alt="alert.name" class="w-10 h-10 rounded-lg object-cover">
                        <div>
                    ...
                    <TableCell>
                      <Badge 
                        :variant="alert.status === 'Out of Stock' ? 'destructive' : 'secondary'"
                      >
                        {{ alert.status }}
                      </Badge>
                    </TableCell>
...
const topCategories = ref([
  { name: 'Electronics', count: 342, percentage: 28, color: 'hsl(var(--primary))' },
...
const topProducts = ref([
  ...
  },
  {
    ...
    revenue: 8500000,
    growth: 22,
    image: 'https://images.unsplash.com/photo-1588423771073-b8903fbb85b5?w=100&h=100&fit=crop&crop=center'
  }
])
...
const inventoryAlerts = ref([
  ...
  },
  {
    ...
    minStock: 12,
    status: 'Low Stock',
    image: 'https://images.unsplash.com/photo-1606983340126-99ab4feaa64a?w=100&h=100&fit=crop&crop=center'
  }
])
...
const filteredAlerts = computed(() => {
  ...
  return inventoryAlerts.value.filter(alert => 
